...
Public Class Home
    ...
    Sub CenterGroup()
        ...
        profile_panel.Width = 200
        profile_panel.Height = 200
        profile_panel.ForeColor = Color.Red
        profile_nama.ForeColor = Color.Green
        profile_role.ForeColor = Color.Green
        profile_nama.Font = New Font(profile_nama.Font.FontFamily, 22, FontStyle.Bold)
        profile_role.Font = New Font(profile_role.Font.FontFamily, 16, FontStyle.Bold)


        profile_panel.Left = ((BackPanel.Width - profile_panel.Width) / 2) + 30
        profile_panel.Top = ((BackPanel.Height - profile_panel.Height) / 2) + 200
        profile_role.Top = BackPanel.Top + 20
        ...
        menu_latihan.Top = menu_latihan.Bottom + (BackPanel.Height - 2 * menu_latihan.Height) / 3

        menu_keluar.Left = (BackPanel.Width - menu_keluar.Width) / 2
        menu_keluar.Top = menu_keluar.Bottom + (BackPanel.Height - 2 * menu_keluar.Height) / 3
    ...
    Private Sub LayoutBelajar()
        ...
        belajar_text.Height = belajar_isi.Height - 80 - 360
        belajar_text.Top = belajar_isi.Top + 40 + 380
        ...
        WebView21.Width = belajar_isi.Height - 20
        WebView21.Height = 360
        WebView21.Left = (belajar_previous.Left + 50) + (belajar_isi.Width - WebView21.Width) \ 2
        Label2.Left = (belajar_default.Width - Label2.Width) / 2
    ...
    Private Sub ShowMateri(index As Integer)
        If index >= 0 AndAlso index < isiMateriList.Count Then
            ...
            If Not String.IsNullOrWhiteSpace(currentSlide.Video) Then
                WebView21.Source = New Uri(currentSlide.Video)
    ...
    Private Sub profile_panel_Paint(sender As Object, e As PaintEventArgs) Handles profile_panel.Paint

    End Sub

    Private Sub profile_nama_Click(sender As Object, e As EventArgs) Handles profile_nama.Click

    End Sub

    Private Sub profile_role_Click(sender As Object, e As EventArgs) Handles profile_role.Click
